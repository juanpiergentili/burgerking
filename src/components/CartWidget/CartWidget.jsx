...
const CartWidget = () => {
    ...
    return (
        <div className="d-flex text-center mt-3">
            ...
            <span className="border border-3 rounded-circle " id="contador-carrito" style={estilosCarrito}>{cartTotal()}</span>
            </Link>
            <button type="button" className="btn position-relative" title="Vaciar Carrito" onClick={()=> {clear()}}>
